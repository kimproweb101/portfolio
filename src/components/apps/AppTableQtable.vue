...
const rows = [
  ...
  {
    name: '인프라',
    field: 'aws, cafe24, netify, Heroku',
  },
  {
    name: '형상관리',
    field: 'git',
  ...
  {
    name: '솔루션&CMS',
    field: '카페24 쇼핑몰, 고도몰5, 그누보드5, 영카트, 워드프레스',
  },
  {
    name: '자격증',
    field: '웹디자인 기능사, 컴퓨터 그래픽스 운용 기능사, 워드프로세서, 운전면허1종보통',
  },
  {
    name: '응용 기술',
    field:
      '회원 가입, 로그인, SNS 로그인, 멀티 게시판, 쇼핑몰, 페이징, 무한 스크롤, 결제 시스템, api연동, AWS배포, HTTPS 인증서 적용, swagger 문서 작성',
  },
  {
    name: '커뮤니케이션',
    field:
      '넓은 스펙트럼과 많은 경험으로 다양한 분야의 직원, 고객분들과 의사 소통 능력이 좋습니다.',
  },
]
</script>
